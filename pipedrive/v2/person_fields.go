...
func (s *PersonFieldsService) Delete(ctx context.Context, fieldCode string, opts ...DeletePersonFieldOption) (*Field, error) {
	...
	resp, err := s.client.gen.DeletePersonField(ctx, fieldCode, toRequestEditors(editors)...)
	if err != nil {
		return nil, err
	}
	responseBody, err := readResponseBody(resp)
...
func (s *PersonFieldsService) AddOptions(ctx context.Context, fieldCode string, labels []string, opts ...AddPersonFieldOptionsOption) ([]FieldOption, error) {
	...
	resp, err := s.client.gen.AddPersonFieldOptionsWithBody(ctx, fieldCode, "application/json", bytes.NewReader(body), toRequestEditors(editors)...)
	if err != nil {
		return nil, err
	}
	responseBody, err := readResponseBody(resp)
...
func (s *PersonFieldsService) UpdateOptions(ctx context.Context, fieldCode string, updates []FieldOptionUpdate, opts ...UpdatePersonFieldOptionsOption) ([]FieldOption, error) {
	...
	resp, err := s.client.gen.UpdatePersonFieldOptionsWithBody(ctx, fieldCode, "application/json", bytes.NewReader(body), toRequestEditors(editors)...)
	if err != nil {
		return nil, err
	}
	responseBody, err := readResponseBody(resp)
...
func (s *PersonFieldsService) DeleteOptions(ctx context.Context, fieldCode string, ids []int, opts ...DeletePersonFieldOptionsOption) ([]FieldOption, error) {
	...
	resp, err := s.client.gen.DeletePersonFieldOptionsWithBody(ctx, fieldCode, "application/json", bytes.NewReader(body), toRequestEditors(editors)...)
	if err != nil {
		return nil, err
	}
	responseBody, err := readResponseBody(resp)
