...
func TestNonPositiveIDsRejectedClientSide(t *testing.T) {
	...
	calls := []struct {
		...
		{"Deals.AddParticipant#id", func() error { _, err := client.Deals.AddParticipant(ctx, 0, 1); return err }},
		{"Deals.AddParticipant#personID", func() error { _, err := client.Deals.AddParticipant(ctx, 1, 0); return err }},
		...
		{"Deals.Merge#id", func() error { _, err := client.Deals.Merge(ctx, 0, 1); return err }},
		{"Deals.Merge#mergeWithID", func() error { _, err := client.Deals.Merge(ctx, 1, 0); return err }},
		...
		{"Organizations.Merge#id", func() error { _, err := client.Organizations.Merge(ctx, 0, 1); return err }},
		{"Organizations.Merge#mergeWithID", func() error { _, err := client.Organizations.Merge(ctx, 1, 0); return err }},
		...
		{"Roles.AddAssignment#id", func() error { _, err := client.Roles.AddAssignment(ctx, 0, 1); return err }},
		{"Roles.AddAssignment#userID", func() error { _, err := client.Roles.AddAssignment(ctx, 1, 0); return err }},
		{"Roles.DeleteAssignment#id", func() error { _, err := client.Roles.DeleteAssignment(ctx, 0, 1); return err }},
		{"Roles.DeleteAssignment#userID", func() error { _, err := client.Roles.DeleteAssignment(ctx, 1, 0); return err }},
